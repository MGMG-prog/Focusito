...
@Composable
fun pregunta2(navController: NavController,
) {
    ...
    Image(
        painter = painterResource(id = R.drawable.quiz2pregunta2),
...
@Composable
fun nyi(navController: NavController) {
    ...
    Column(
        ...
        Button(
            onClick = {
                navController.navigate(Screen.quiz2pregunta3.route)
            },
            enabled = selectedOption != null,
            colors = ButtonDefaults.buttonColors(
...
@Composable
fun opi() {
    pregunta2(navController = rememberNavController())
}
