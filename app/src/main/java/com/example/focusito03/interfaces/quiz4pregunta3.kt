...
@Composable
fun n(navController: NavController) {
    ...
    Column(
        ...
        val options = listOf(
            "A" to "A. Para introducir  una consecuencia o conclusión.",
            "B" to "B. Para expresar  contraste u oposición.",
            "C" to "C. Para crear  duda."
        )
        ...
        Button(
            {navController.navigate(Screen.quiz4pregunta4.route)},
