...
@Composable
fun Quiz4preguntao(navController: NavController,
) {
...
@Composable
fun nyvntw(navController: NavController) {
    ...
    Column(
        ...
        val options = listOf(
            "A" to "A. Variar el tono para expresar  una emoción o significado.",
            "B" to "B. Enfatizar  puntos importantes para la absorción de la información.",
            "C" to "C. Crear  incertidumbre y confusión de lo que se comenta."
        )
        ...
        Button(
            onClick = {
                navController.navigate(Screen.quiz4pregunta2.route)
            },
            enabled = selectedOption != null,
            colors = ButtonDefaults.buttonColors(
...
@Composable
fun oponp() {
    Quiz4preguntao(navController = rememberNavController())
}
