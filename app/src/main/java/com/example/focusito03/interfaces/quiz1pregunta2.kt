...
fun quiz1pregunta2(navController: NavController,
    ...
    Image(
        painter = painterResource(id = R.drawable.quiz1pregunta2),
...
@Composable
fun ny2(navController: NavController) {
    ...
    Column(
        ...
        val options = listOf(
            "A" to "A. En la letra I",
            "B" to "B. En la letra A",
            "C" to "C. En la letra O"
        )
        ...
        Button(
            onClick = {
                navController.navigate(Screen.quiz1pregunta3.route)
            },
            enabled = selectedOption != null,
            colors = ButtonDefaults.buttonColors(
...
@Composable
fun opp() {
    quiz1pregunta2(navController = rememberNavController())
}
