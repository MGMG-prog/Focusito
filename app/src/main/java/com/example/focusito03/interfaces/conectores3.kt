...
@Composable
fun PantallaConectores3(navController: NavController,) {
    Box(
        ...
        val opciones = listOf("Por ejemplo","a pesar de", "no obstante", "incluso")
        val correctAnswerIndex = 3
        ...
        Column(
            ...
            Text(
                text = " Me encanta el cine, ____ prefiero ver películas en casa.",
                color = Color.Black,
                fontSize = 20.sp,
            ...
            opciones.forEachIndexed { index, opcion ->
                ...
                Button(
                    {navController.navigate(Screen.conector4.route)},
...
@Composable
fun hoppppe() {
    PantallaConectores3(navController = rememberNavController())
}
