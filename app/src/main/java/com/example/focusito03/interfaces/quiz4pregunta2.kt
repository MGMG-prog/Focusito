...
@Composable
fun nyvntwe(navController: NavController) {
    ...
    Column(
        ...
        val options = listOf(
            "A" to "A. Son signos de puntuación para separar oraciones.",
            "B" to "B. Es el orden  cronológico en el que se cuentan hechos.",
            "C" to "C. Recurso  expresivo para resaltar y dar importancia con el fin de atraer la atención."
        )
        ...
        Button(
            onClick = {
                navController.navigate(Screen.quiz4pregunta3.route)
            },
            enabled = selectedOption != null,
            colors = ButtonDefaults.buttonColors(
