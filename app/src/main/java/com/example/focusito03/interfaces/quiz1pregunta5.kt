...
@Composable
fun quiz1pregunta5(navController: NavController,
) {
    Image(
        painter = painterResource(id = R.drawable.quiz1pregunta5),
...
@Composable
fun ny5(navController: NavController) {
    ...
    Column(
        ...
        Button(
            {navController.navigate(Screen.terminastequiz1.route)},
...
@Composable
fun oppppp() {
    quiz1pregunta5(navController = rememberNavController())
}
