...
@Composable
fun PantallaConectores(navController: NavController,) {
    Box(
        ...
        val opciones = listOf("Porque", "Sin embargo", "Y", "Además")
        ...
        Column(
            ...
            Text(
                text = "No estudió para el examen _______ aprobó con la mejor nota.",
                color = Color.Black,
                fontSize = 20.sp,
            ...
            opciones.forEachIndexed { index, opcion ->
                ...
                Button(
                    {navController.navigate(Screen.conector2.route)},
...
@Composable
fun hoppp() {
    PantallaConectores(navController = rememberNavController())
}
