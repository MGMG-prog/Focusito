...
@Composable
fun nah(navController: NavController,) {
    ...
    Button(
        ...
        Text(
            text = "A. Para expresar una idea contraría a la esperada.",
            color = Color.Black,
            fontSize = 16.sp
        )
    }
    ...
    Button(
        ...
        Text(
            text = "C. Para introducir consecuencia o conclusión.",
            color = Color.Black,
            fontSize = 16.sp
        )
    }
...
@Composable
fun tersim7() {
    Quiz4pregunta4(navController = rememberNavController())
}
