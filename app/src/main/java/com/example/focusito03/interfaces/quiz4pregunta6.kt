...
@Composable
fun Quiz4pregunta6(navController: NavController,
) {
    ...
    Image(
        painter = painterResource(id = R.drawable.quiz4pregunta6),
...
@Composable
fun nahhh(navController: NavController) {
    ...
    Column(
        ...
        val options = listOf(
            "A" to "A. Transmisión de noticias y premisas.",
            "B" to "B. Es un idioma secreto que utilizan los escritores.",
            "C" to "C. Proceso  mediante el cuál se transmiten ideas, información, sentimientos dos personas o más."
        )
        ...
        Button(
            onClick = {
                navController.navigate(Screen.quiz4pregunta7.route)
            },
            enabled = selectedOption != null,
            colors = ButtonDefaults.buttonColors(
...
@Composable
fun tersim99h() {
    Quiz4pregunta6(navController = rememberNavController())
}
