...
fun nahhh(navController: NavController,) {
    ...
    Button(
        ...
        Text(
            text = "A. Transmisión de noticias y premisas ",
            color = Color.Black,
            fontSize = 16.sp
        )
    }
    ...
    Button(
        ...
        Text(
            text = "B. Es un idioma secreto que utilizan los escritores.",
            color = Color.Black,
            fontSize = 16.sp
        )
    }
    ...
    Button(
        ...
        Text(
            text = "C. Proceso  mediante el cuál se transmiten ideas, información, sentimientos dos personas o más.",
            color = Color.Black,
            fontSize = 16.sp
        )
    }
