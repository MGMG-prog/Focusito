...
@Composable
fun preguntaoou(navController: NavController,
) {
...
@Composable
fun nononoyno(navController: NavController) {
...
@Composable
fun oponiop() {
    preguntaoou(navController = rememberNavController())
}
